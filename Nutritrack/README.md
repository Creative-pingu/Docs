...
This folder contains all documentation for the NutriTrack PWA project.

## Structure

- [PROJECT_CHARTER.md](./PROJECT_CHARTER.md) - Project vision, scope, and governance
- [RISK_REGISTER.md](./RISK_REGISTER.md) - Active risks and mitigations
...
- **Worker**: https://nutritrack-proxy.nickkropf.workers.dev
